...
export class ApplicationService {
  ...
  createApplication(application: Application): Observable<any> {
    return this.http.post<any>(
      this.baseUrl + 'application/create-application',
      application
    );
  }
  ...
  createApplicationDetail(application: ApplicationDetail): Observable<any> {
    return this.http.post<any>(
      this.baseUrl + 'application/create-application-detail',
      application
    );
  }

  getApplicationDetail(id: string): Observable<any> {
    return this.http.get<any>(this.baseUrl + 'application/get-detail?Id=' + id);
  }
}
